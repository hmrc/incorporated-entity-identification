...
@Singleton
class StoreJourneyIdService @Inject()(incorporatedEntityIdentificationRepository: IncorporatedEntityIdentificationRepository,
  ...
  def createJourney(): Future[String] = {
    ...
    incorporatedEntityIdentificationRepository.insert(IncorporatedEntityIdentificationModel(journeyId))
      .map(_ => journeyId)
  }
